...
int main(int argc, char** argv) {
    ...
    thread receiverThread(runReceiverV, n_recv, n_send, port,
    ...
    thread senderThread(runSenderV, n_send, port,
                        std::ref(phaseBarrier),
    ...
    cout << "===============================================" << endl;
    cout << "  ReceiverV set:             2^" << recvLog << " = " << n_recv << endl;
    cout << "  SenderV   set:             2^" << sendLog << " = " << n_send << endl;
    ...
    cout << "===============================================" << endl;
    cout << "  ReceiverV offline time:    " << setw(10) << offTime            << " seconds" << endl;
    cout << "  ReceiverV online  time:    " << setw(10) << onTime             << " seconds" << endl;
    ...
    cout << "  SenderV   online  data:    " << setw(10) << senderOnlineSend / 1024.0 / 1024.0 << " MB" << endl;
    cout << "  ReceiverV online  data:    " << setw(10) << receiverOnlineSend / 1024.0 / 1024.0 << " MB" << endl;
    cout << "===============================================" << endl;
