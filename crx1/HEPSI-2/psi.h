...
public:
    ...
    vector<bool> judge_set;
    vector<Ciphertext> he_vector;
    vector<Plaintext> index_vector;
    vector<Plaintext> random_vector;

    vector<Ciphertext> recv_heVector;
...
public:
    ...
    vector<vector<uint64_t>> hash_vector;
    vector<vector<uint64_t>> half_hash_vector;

    vector<pair<uint64_t, uint64_t>> resultIndex_long;
