...
TEST(binfuse_sfilter, large64) { // NOLINT
  test_sharded_filter<binary_fuse64_t>(load_sample(), 0.000001);
}

TEST(binfuse_sfilter, large64_32) {                                  // NOLINT
  test_sharded_filter<binary_fuse64_t>(load_sample(), 0.000001, 5); // 5 sharded_bits
}
